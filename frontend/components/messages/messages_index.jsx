    ...
    <>
      <ul id="messages-index" className = {reacting.messageId ? "reacting" : ""} style={{ "height": `calc(100% - 40px - ${formHeight}px${replying ? " - 34px" : ""})` }}>
        ...
        {showBlanks ? <div style={{
          position: "fixed", top: "53px", left: "312px", right: (messagesIndex.user ? 0 : "240px"), bottom: "62px", zIndex: 1,
          minWidth: (messagesIndex.user ? "472px" : "232px"), paddingLeft: "16px", backgroundColor: "#36393F",
